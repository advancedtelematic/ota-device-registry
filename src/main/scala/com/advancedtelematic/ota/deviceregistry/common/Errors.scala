...
object Errors {
  ...
  object Codes {
    ...
    val EmptyGroupExpression               = ErrorCode("empty_group_expression")
  }
  ...
  val EmptyGroupExpression =
    RawError(Codes.EmptyGroupExpression, StatusCodes.BadRequest, "Please provide a group expression.")
