...
object DeviceDeleted {
  ...
  implicit val EncoderInstance     = io.circe.generic.semiauto.deriveEncoder[DeviceDeleted]
  implicit val DecoderInstance     = io.circe.generic.semiauto.deriveDecoder[DeviceDeleted]
