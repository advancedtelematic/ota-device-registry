...
import com.advancedtelematic.ota.deviceregistry.data.DataType.{DeviceT, DeviceUuids, InstallationStat, PackageListItem, PackageListItemCount, RenameTagId, UpdateDevice, UpdateTagValue}
