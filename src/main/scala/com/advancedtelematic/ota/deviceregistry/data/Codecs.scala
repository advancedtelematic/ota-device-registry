...
import com.advancedtelematic.ota.deviceregistry.data.DataType.{DeviceT, InstallationStat, PackageListItem, PackageListItemCount, RenameTagId, UpdateDevice, UpdateTagValue}
