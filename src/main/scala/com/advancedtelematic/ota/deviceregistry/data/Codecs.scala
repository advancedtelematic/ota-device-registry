...
import com.advancedtelematic.ota.deviceregistry.data.DataType.{DeviceIds, DeviceT, InstallationStat, PackageListItem, PackageListItemCount, RenameTagId, UpdateDevice, UpdateTagValue}
import com.advancedtelematic.ota.deviceregistry.data.DataType.{DeviceIds, DeviceT, InstallationStat, PackageListItem, PackageListItemCount, RenameTagId, UpdateDevice}
...
object Codecs {
  ...
  implicit val deviceIdsCodec = io.circe.generic.semiauto.deriveCodec[DeviceIds]
}
